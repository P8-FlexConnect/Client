...
public class ObservableRangeCollection<T> : ObservableCollection<T>
{
    ...
    public void AddRange(IEnumerable<T> collection, NotifyCollectionChangedAction notificationMode = NotifyCollectionChangedAction.Add, bool insertAtZero = false)
    {
        ...
        var startIndex = insertAtZero ? 0 : Count;

        var itemsAdded = AddArrangeCore(collection, insertAtZero);
    ...
    private bool AddArrangeCore(IEnumerable<T> collection, bool insertAtZero = false)
    {
        var itemAdded = false;
        foreach (var item in collection)
        {
